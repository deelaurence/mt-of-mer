...
const [animateMore, setAnimateMore]=useState(false)
  return (
    <Link className='flex justify-center' to={link}>
          ...
          className='relative mb-4 mx-6 w-[160px] h-[160px] cursor-pointer rounded-full border-2 border-darkShade sm:mx-16 p-3 items-center justify-center opacity-80 flex gap-2 '>
            ...
            <p className=' text-darkShade font-semibold '>{text}</p>
